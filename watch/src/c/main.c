...
static void window_load(Window *window) {
    ...
    s_icon_other = gbitmap_create_with_resource(RESOURCE_ID_ICON_OTHER);
    ...
    action_bar_layer_set_icon(s_action_bar, BUTTON_ID_SELECT, s_icon_other);
